...
namespace Commands.Create.CreatePlayer.CreateDifferentPosition
{
    public class CMCreate
    {
        ...
        /// </summary>
        static List<string> possiblePositions = new List<string> { "CM", "LB", "CDM", "RB", "CAM" };
        ...
        /// create a LB
        /// </summary>
        /// <returns> positions of the CM </returns>
        public static string[] CreatePositionCM()
        {
            possiblePositions = new List<string> { "CM", "LB", "CDM", "RB", "CAM" };
            ///<summary>
