...
namespace Commands.Create.CreatePlayer.CreateDifferentPosition
{
    public class RBCreate
    {
        ...
        /// </summary>
        static List<string> possiblePositions = new List<string> { "RB", "CB", "CDM", "LB" };
        ...
        /// create a LB
        /// </summary>
        /// <returns> positions of the RB </returns>
        public static string[] CreatePositionRB()
        {
            possiblePositions = new List<string> { "RB", "CB", "CDM", "LB" };
            ///<summary>
