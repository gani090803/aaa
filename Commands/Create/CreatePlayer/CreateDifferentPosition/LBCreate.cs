...
namespace Commands.Create.CreatePlayer.CreateDifferentPosition
{
    public class LBCreate
    {
        ...
        /// </summary>
        static List<string> possiblePositions = new List<string> { "LB", "CB", "CDM", "RB" };
        ...
        /// create a LB
        /// </summary>
        /// <returns> positions of the LB </returns>
        public static string[] CreatePositionLB()
        {
            possiblePositions = new List<string> { "LB", "CB", "CDM", "RB" };
            ///<summary>
